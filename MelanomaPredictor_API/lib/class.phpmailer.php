...
class PHPMailer {
	 ...
	 * @var string
	 */
	public $From              = 'pmf-alert@cellworksgroup.com';
	
	/**
	 * Sets the From name of the message.
	 * @var string
	 */
	public $FromName          = 'PMF Mailer';
	 ...
	 * @var string
	 */
	//  public $Host          = 'smtp.bizmail.yahoo.com:25';
	// 	public $Host          = 'smtp.logix.in:587';
	public $Host          = 'zsmtp.hybridzimbra.com:587';
	 ...
	 * @var string
	 */
	public $Username      = 'pmf-alert@cellworksgroup.com';
	
	/**
	 * Sets SMTP password.
	 * @var string
	 */
	public $Password      = 'Alert@1234';
